...
datat=data[['CLDN11','HGF','CDH1','SEZ6','MLH1','DOCK3','SEZ6L','VTN','EPM2A','CD274','SMAD9','ACVR2A','F12','VEGFC','ALK','TCEA2','CTSF','SEZ6L2','SULT1C4','MSS-Normal','ZNF43']]
...
model_dowhy=dowhy.causal_model.CausalModel(datat,treatment="F12",outcome="MSS-Normal",graph=gmlstring)
